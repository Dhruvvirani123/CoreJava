...
<!-- Page Icon -->
<link rel="icon"
	href="https://media.istockphoto.com/id/960975348/vector/medical-care-vector-icon.jpg?s=612x612&w=0&k=20&c=7y4z4_yP2AbYap58W9dANYuFf3K-dqEDhCZax0pmMyo=">
					...
					<div class="col-lg-7 top-social-agile">
						<div class="row">
							...
							<div
								...
								<p class="text-white">
									<i class="fas fa-map-marker-alt mr-2"></i>Bims Hospital, Kala
									Nala, Bhavnagar.
								</p>
							</div>
						</div>
				...
				<div class="container">
					...
					<h1>
						<a class="navbar-brand font-weight-bold font-italic"
							href="Index.jsp"> <span>M</span>edic <i
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					...
					<br>
					<h4 class="text-center"><a href="user-Forgot-Password.jsp">Forgot Password?</a></h4>
				</div>
				...
				<div class="row">
					<div class="col-md-4 w3l-footer">
						<h2 class="mb-sm-3 mb-2">
							<a href="Index.jsp"
								class="text-white font-italic font-weight-bold"> <span>M</span>edic
					...
					<div class="col-md-4 w3l-footer">
						...
						<div class="nav-w3-l">
							<ul class="list-unstyled">
								...
								<li class="mt-2"><a href="appointment.html">Appointment</a>
								</li>
								<li class="mt-2"><a href="contact.html">Contact Us</a></li>
							</ul>
						</div>
					</div>
				</div>
