        ...
        <div class="container-fluid">
          <div class="top_nav_container">
            ...
            <div class="user_option_box">
              <a href="login-Registration-page.jsp" class="account-link">
        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="index.jsp">
              <span>
                <img alt="" src="https://cdn.sanity.io/images/6icyfeiq/production/9416c4795d650652903a7fa5db664eb0d91153b6-542x200.png">
              </span>
            </a>
